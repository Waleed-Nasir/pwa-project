                      ...
                      <div className="single-blog-post">
                        ...
                        <div className="blog-info">
                          ...
                          <div className="post-admin">
                            By <a href="#">admin</a> /<a href="#">12</a>{" "}
                            Comments
                          </div>
                          <p>
                            Aliquet id lacinia ultricies odio, neque ipsum
                            facilisis parturient. Erat tristique nonummy etiam,
                            fusce est porttitor.
                          </p>
                          <Link href="/details">
                  ...
                  <div className="recent-post">
                    ...
                    <div className="single-recent-post">
                      <Link href="/details">
                        <a>
                          <img
                            src={require("../../images/blog/recent-post-1.jpg")}
                            alt="blog"
                          />
                        </a>
                      </Link>
                      <h5>
                        <a href="/details">How to customize HeroApp</a>
                      </h5>
                      <p>Mar 21, 2019</p>
                    </div>
                    <div className="single-recent-post">
                      <Link href="/details">
                        <a>
                          <img
                            src={require("../../images/blog/recent-post-2.jpg")}
                            alt="blog"
                          />
                        </a>
                      </Link>
                      <h5>
                        <a href="/details">Awesome app landing page</a>
                      </h5>
                      <p>Mar 22, 2019</p>
                    </div>
                    <div className="single-recent-post">
                      <Link href="/details">
                        <a>
                          <img
                            src={require("../../images/blog/recent-post-3.jpg")}
                            alt="blog"
                          />
                        </a>
                      </Link>
